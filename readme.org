...
- 这个项目，因为【安卓Compose】同【Material3】的兼容性问题，可能适配起来比较困难一点儿，先放一放。
- 今天晚上把源项目，又编译了一遍、可以编译通过，并运行，完全没有问题；只是自己后来修改添加功能等，出现了编译不过。明天会花时间一点一点儿把这个编译不通的【BUG：】解决掉。
  - 今天上午弄，最终的结果成为是：【安卓Compose】不能真正识别底层的【非 compose 的 kotline 语言的 colorpicker 库】？还没弄明白是为什么。因为自己现在的项目【安卓 compose月历、年历】是可以调用底层的【compose 月历库】的
  - 现在暂时的解决办法以是：把【底层 colorpicker 库】，合用入 [app] 项目里，弄成了一个非常庸肿的 app, 但能够编译通过，算是解决了前几个周、这个项目不知道为什么【无法编译通过】的问题。 *【TODO：】会顺着现在的进展，把自己2 年前、有些显而易见的【BUG：】修改掉，改到方便好用，供亲爱的表哥的活宝妹、笨宝妹手机上日常使用的程度。* 【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】
  - 等这些【BUG：】修改完后，会回来再看： *【TODO：】【安卓Compose】不能真正识别底层的【非 compose 的 kotline 语言的 colorpicker 库】？？？*
- *【亲爱的表哥的活宝妹，任何时候，亲爱的表哥的活宝妹，就是一定要、一定会嫁给活宝妹的亲爱的表哥！！！爱表哥，爱生活！！！】*
* Android Compose
